...
def obd_login_table(wbk_dx,table_dx):
    ...
    for dx in xrange(len_dx):
        if type(imei_dx[dx]) == unicode and imei_dx[dx][0:4] == '8692':
...
def xls_handling(wbk_dx,table_dx):
    ...
    for row in xrange(1,rows_xh):
        ...
        if rows_value[var.col_imei] in imei_lp:
            ...
            if value_lp1 == '2' and value_lp2 != '2' and value_lp3 != '2' and value_lp4 != '2' and value_lp5 != '2':
                if value_lp2 != '4' and value_lp3 != '4' and value_lp4 != '4' and value_lp5 != '4':
        ...
        print rows_value[var.col_imsi-2]
        '''
...
if __name__ == '__main__':
    ...
    wbk_dx,table_dx = fn.openxlrd(r'D:\xiao\obd\20141125-161041-obd-data.xls',u'data')

    obd_login_table(wbk_dx,table_dx)
    
    
    xls_handling(wbk_dx,table_dx)
